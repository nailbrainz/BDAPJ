...
public class BloomFilter<E> implements Serializable {
    ...
    /**
      ...
      */
    public BloomFilter(double c, int n, int k, long id) {
    	this.id = id;
     ...
     */
    public BloomFilter(int bitSetSize, int expectedNumberOElements, long id) {
        this(bitSetSize / (double)expectedNumberOElements,
             expectedNumberOElements,
             (int) Math.round((bitSetSize / (double)expectedNumberOElements) * Math.log(2.0)), id);
    }
     ...
     */
    public BloomFilter(double falsePositiveProbability, int expectedNumberOfElements, long id) {
        this(Math.ceil(-(Math.log(falsePositiveProbability) / Math.log(2))) / Math.log(2), // c = k / ln(2)
             expectedNumberOfElements,
             (int)Math.ceil(-(Math.log(falsePositiveProbability) / Math.log(2))), id); // k = ceil(-log_2(false prob.))
    }
     ...
     */
    public BloomFilter(int bitSetSize, int expectedNumberOfFilterElements, int actualNumberOfFilterElements, BitSet filterData, long id) {
        this(bitSetSize, expectedNumberOfFilterElements, id);
